...
public class ModuleBootstrap extends AbstractModuleBootstrap {
    ...
    public final static String MODULE_ID = "cp";
    ...
    public void init() throws Exception {
        moduleConfig = loadConfiguration("cp.conf");
        _registerMenu();
        _initCounterFactory();
    }
    ...
    private void _registerMenu() {
        ...
        String url = controllers.cp.routes.ModuleController.dashboard().url();
        MenuItem menuBarItem = new MenuItem(MODULE_ID, Messages.get(lang, "msg.cp.title"), url,
                Messages.get(lang, "msg.cp.desc"));
